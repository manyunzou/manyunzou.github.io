...
<g class='axis x-axis' class:snapTicks>
  {#each tickVals as tick, i}
    {#if i%5==0} <!--散开x轴的标注-->
      <g class='tick tick-{ i }' transform='translate({$xScale(tick)},{$yRange[0]*0.66})'>
        {#if gridlines !== false}
        ...
        <text
          ...
          dx=''
          dy=''
          text-anchor='{textAnchor(i)}'>2019</text>
        {/if}
        ...
        <text
          ...
          dx=''
          dy=''
          text-anchor='{textAnchor(i)}'>2020</text>
        {/if}
        ...
        <text
          ...
          dx=''
          dy=''
          text-anchor='{textAnchor(i)}'>2021</text>
        {/if}
